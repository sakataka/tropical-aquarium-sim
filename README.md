...
起動するとフィッシュルームが表示され、並んだ水槽のガラスの中では実際の水景と魚が泳いでいます。水槽を選ぶとカメラが寄り、そのまま水槽を画面いっぱいに眺める鑑賞モードへ入ります。鑑賞モードの操作ボタンは、しばらく操作しないと消えます。「設定」で操作パネルを開き（狭い画面では下から）、「閉じて眺める」で鑑賞モードへ戻ります。「部屋に戻る」で引いてフィッシュルームへ戻ります。
